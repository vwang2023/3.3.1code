...
#calls the function to find the min/max/avg for total deaths in Italy
print("MIN/MAX/AVG FOR DEATHS")
minmaxavg('deaths', 'deaths')

#calls the function to find the min/max/avg for total confirmed cases in Italy
print("MIN/MAX/AVG FOR TOTAL CONFIRMED CASES")
minmaxavg('total_confirmed_cases', 'total confirmed cases')

#calls the function to find the min/max/avg for confirmed cases per day in Italy
